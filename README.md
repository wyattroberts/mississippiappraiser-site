# Mississippi Appraiser

Replacement public site for `mississippiappraiser.com`. It preserves the
...
- Build command: `npm ci && npm run do:build`
- Run command: `npm run do:start`
- HTTP port: `8080`

The existing Sites/Vinext scripts remain available for the emergency hosted
checkpoint and local QA.
